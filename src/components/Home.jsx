...
const socialMediaLinks = [
  { href: '#', icon: faTwitter },
  { href: 'https://www.linkedin.com/in/akshay72', icon: faLinkedin },
  { href: 'https://github.com/akshybhosale', icon: faGithub },
  { href: "https://mail.google.com/mail/u/0/?fs=1&to=akshay.in72@gmail.com&tf=cm", icon: faEnvelope },
];
